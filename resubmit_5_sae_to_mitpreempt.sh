#!/bin/bash
# Resubmit 5 confidence 0.0 SAE jobs to mit_preemptable partition
...
echo "Resubmitting 5 SAE jobs to mit_preemptable..."
echo ""
...
echo ""
echo "Resubmitted 5 jobs to mit_preemptable"
