...
"""
genome_scoring_locus_suite.py (Consolidated Jan 2026)

Old working script + new upgrades:
- Robust logits extraction for tuple/nested model outputs (fixes your crash).
