...
Examples:
  ...
  # Fast mode: bf16 + batched chunks (2-4x faster)
  python score_chromosome.py --chrom chr22 --n_gpus 0 --auto_chunk_size --bf16 --batch_size 4

  # Maximum throughput: bf16 + batching + RC averaging
  python score_chromosome.py --chrom chr22 --n_gpus 0 --auto_chunk_size \
      --bf16 --batch_size 4 --rc_average --compute_logprobs
        """
    )
    ...
    parser.add_argument("--target_chunk_size", type=int, default=1_000_000,
                        help="Starting chunk size for auto-probing (default: 1000000). "
    ...
    parser.add_argument("--bf16", action="store_true", default=True,
                        help="Use bfloat16 autocast for forward passes (default: enabled). "
