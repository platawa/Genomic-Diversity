#!/bin/bash
#SBATCH -J umap_gw_norm
#SBATCH -p pi_zhang_f
#SBATCH --cpus-per-task=32
#SBATCH --mem=500G
#SBATCH -t 3-00:00:00
#SBATCH -o logs/umap_gw_norm_%j.log
#SBATCH -e logs/umap_gw_norm_%j.err
...
LOCAL_DIR="/tmp/sae_tsne_cache_umap_${SLURM_JOB_ID}"
mkdir -p "$LOCAL_DIR"
...
# Copy existing caches (PCA, neighbors from t-SNE run should already exist)
...
echo "[$(date)] Running normalized UMAP pipeline (--embedding umap --n_pca 50)..."
